...
- If user asks for a chart use render_complex_chart to generate it and add the value of the key 'image_base64' in the response dictionary to the final answer as a fenced PNG code block.
