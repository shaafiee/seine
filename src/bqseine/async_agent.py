...
- For final answer, provide a brief natural-language summary, include the SQL statement you created in a fenced code block, and include the output from that SQL as an HTML <table> in a fenced code block.
...
def process(job = '',
	...
	resp = completed_job.results[0].response
